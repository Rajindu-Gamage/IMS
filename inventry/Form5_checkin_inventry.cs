...
namespace inventry
{
    public partial class Form5_checkin_inventry : Form
    {
        public Form5_checkin_inventry()
        {
            InitializeComponent();
        }
        private void BindDataGridView()
        {
            ...
            con.Open();
            string Query = "SELECT * FROM [View_Tb_checkin];";
        ...
        private void bt_update_Click(object sender, EventArgs e)
        {
            ...
            string Query = "Update Tb_checkin_inventry set Item_Name = '" + Item_Name + "' , Number_of_Box = '" + Number_of_box + "' , Quantity = '" + Quantity + "' " +
        ...
        private void bt_check_In_Click_1(object sender, EventArgs e)
        {
            ...
            string Number_of_box = textBox3.Text;
            string Quantity = textBox4.Text;
            string Query = "insert into Tb_checkin_inventry(Item_Code, Item_Name, Number_of_box, Quantity) " +
                "values('" + Item_Code + "', '" + Item_Name + "', '" + Number_of_box + "', '" + Quantity + "' );";
        ...
        private void InsertDataIntoDatabase()
        {
            ...
            SqlConnection con = new SqlConnection(Connectionstring);
            con.Open();
            using (SqlCommand command = new SqlCommand("AddProduct_check_in", con))
            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string Number_of_box = textBox3.Text;
            string Quantity = textBox4.Text;
            string Query = "select * from Tb_checkin_inventry where Item_Code = '" + Item_Code + "'";
            SqlCommand cmd = new SqlCommand(Query, con);
            var reader = cmd.ExecuteReader();
        ...
        private void Form5_checkin_inventry_Load(object sender, EventArgs e)
        {
            BindDataGridView();
        }
    }
